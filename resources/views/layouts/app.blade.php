			...
			<div class="left-side">
				...
				<nav id="navigation">
					<ul id="responsive">
						...
						<li><a href="localhost:8000/register" class="current">Dashboard</a>
							<ul class="dropdown-nav">
								<li><a href="localhost:8000/register">Dashboard</a></li>
								...
								<li><a href="/freelancer/proposals">Settings</a></li>
							</ul>
						</li>
				...
				<div class="header-widget">
					...
					<div class="header-notifications user-menu">
						...
						<ul class="user-menu-small-nav">
							<li><a href="/register"><i class="icon-material-outline-dashboard"></i> Dashboard</a></li>
							<li><a href="{{ route('proposals.index') }}"><i class="icon-material-outline-settings"></i> Settings</a></li>
