                            ...
                            <div class="header-notifications user-menu">
                                ...
                                <div class="header-notifications-dropdown">
                                    ...
                                    <ul class="user-menu-small-nav">
                                        <li><a href="{{ route('categoris.index') }}"><i class="icon-material-outline-dashboard"></i> Dashboard</a></li>
                                        <li><a href="{{ route('freelancer.proposals.index') }}"><i class="icon-material-outline-settings"></i> Settings</a></li>
